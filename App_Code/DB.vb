...
Public Module DB
    ...
    Public Function BringDataInDataList(ByVal ConnectionString As String, ByVal SQL As String) As List(Of String)
        Dim ColumnsToShow As New List(Of String)
        Dim DT As New DataTable
        DT = GetDataTable(ConnectionString, SQL)
        If DT.Rows.Count > 0 Then



            For Each DR As DataRow In DT.Rows
                ColumnsToShow.Add(DR(0).ToString)
            Next

        End If

        BringDataInDataList = ColumnsToShow
